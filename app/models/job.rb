class Job < ActiveRecord::Base
  ...
  validates_inclusion_of :paid, :in => [true, false], :message => "^Geben Sie bitte die Art der Arbeit an!"
  ...
  validates_inclusion_of :offer_or_quest, :in => [true, false], :message => "^Geben Sie bitte den Typ der Annonce an!"

...
class Job < ActiveRecord::Base
  belongs_to :user
  attr_accessible :counter, :agb, :paid, :salary, :employment_status, :company, :begindate, :place, :qualification, :title, :description, :firstname, :lastname, :email, :telephone, :is_offer
